...
import static com.consiliuminc.sras.consts.AppConst.WAV_EXTENSION;
    ...
    public static List<Path> convertAudioToWav(String outputPath, List<Path> paths) throws IOException, InterruptedException {
        ...
        for (Path path : paths) {
            ...
            if (sourceFile.exists()) {
                ...
                destinationFile = new File(Paths.get(outputPath, sourceFile.getName().replace(extension, WAV_EXTENSION)).toString());
